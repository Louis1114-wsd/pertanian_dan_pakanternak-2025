...
class PupukPolicy
{
    ...
    {
        return $user->can('view_any_pupuk');
    }
    ...
    {
        return $user->can('delete_any_pupuk');
    }
     ...
     */
    public function replicate(User $user, Pupuk $pupuk): bool
    {
